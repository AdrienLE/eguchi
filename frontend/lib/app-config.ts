/**
 * Eguchi Ear Trainer Configuration
...
export const BRANDING_CONFIG = {
  appName: 'Eguchi Ear Trainer',
  displayName: 'Eguchi Ear Trainer',
  description: 'An app built with the Base App template',
  version: '1.0.0',
  company: 'Eguchi Labs',
